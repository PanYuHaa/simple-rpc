...
public class RpcConfig {
     ...
     * 服务端额外配置数据
     */
    public Map<String,Object> serviceAttachments = new HashMap<>();
    public Map<String,Object> getServiceAttachments() {return serviceAttachments;}

    /**
     * 客户端额外配置数据
     */
    public Map<String,Object> clientAttachments = new HashMap<>();
    public Map<String,Object> getClientAttachments() {return clientAttachments;}
